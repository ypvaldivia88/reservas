...
export default function ReservasTable({
  ...
  useEffect(() => {
    if (externalEstadoFilter !== undefined) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-2">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-2 sm:gap-3 min-w-0">
          <svg
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 glass-panel rounded-xl p-2 sm:p-2.5">
        ...
        >
          {!searchExpanded ?
            <>
              <div className="p-1.5 sm:p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors flex-shrink-0">
                <svg
              ...
              <span className="text-xs sm:text-sm text-gray-400 dark:text-gray-500 select-none truncate">
                Buscar...
              </span>
            </>
          : <div className="flex min-w-0 flex-1 items-center gap-3 pl-1">
              ...
              >
                <svg
                  className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-400 dark:text-gray-500"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
