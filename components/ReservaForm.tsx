...
export default function ReservaForm() {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden transition-colors duration-200">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 px-4 py-4 sm:px-6 sm:py-5 md:px-8 md:py-6 text-white">
        ...
        <form className="space-y-4 sm:space-y-6">
          ...
          {currentStep === 1 && (
            <div className="space-y-3 sm:space-y-4 animate-fadeIn">
              ...
              {showClientInfo && clientInfo && (
                <div className="mt-3 p-3 sm:p-4 bg-blue-50 dark:bg-blue-900/20 border-2 border-purple-200 dark:border-purple-700 rounded-lg">
                        ...
                        <div>
                          ...
                          <div className="space-y-2">
                            {clientInfo.reservasActivas.map((reserva) => (
                              <div
                                key={reserva._id}
                                className="text-xs sm:text-sm bg-white dark:bg-gray-800 p-2 rounded border border-purple-200 dark:border-purple-700"
                              >
          ...
          {currentStep === 3 && (
            <div className="space-y-3 sm:space-y-4 animate-fadeIn">
              ...
              <div>
                ...
                {form.largo && (
                  <div className="mt-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-purple-200 dark:border-purple-700">
              ...
              <div>
                ...
                {selectedColors.length > 0 && (
                  <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-purple-200 dark:border-purple-700">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedColors.map((color) => {
                        ...
                        return (
                          <div
                            key={color}
                            className="flex items-center gap-2 px-2 py-1 bg-white dark:bg-gray-800 rounded-full border border-purple-200 dark:border-purple-700"
                          >
                            <span
                              className="w-4 h-4 rounded-full border border-gray-300 dark:border-gray-500"
                              style={{
          ...
          {currentStep === 4 && (
            <div className="space-y-4 animate-fadeIn">
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-blue-900/20 dark:to-violet-900/20 p-6 rounded-xl border-2 border-purple-200 dark:border-purple-700">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-blue-900/20 dark:to-violet-900/20 p-4 sm:p-6 rounded-lg sm:rounded-xl border border-purple-100 dark:border-purple-800">
          ...
          <div className="flex gap-3 pt-3 sm:pt-4">
            ...
            {currentStep < totalSteps ?
              <button
                type="button"
                onClick={handleNext}
                className="flex-1 px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-purple-600 to-pink-600 dark:from-blue-500 dark:to-violet-500 text-white rounded-lg sm:rounded-xl text-sm sm:text-base font-semibold hover:shadow-lg hover:shadow-purple-500/25 dark:hover:shadow-purple-400/25 transform hover:-translate-y-1 transition-all duration-300"
              >
                Siguiente →
              </button>
            : <button
                ...
                className="flex-1 px-4 sm:px-6 py-3 sm:py-4 bg-gradient-to-r from-purple-600 to-pink-600 dark:from-blue-500 dark:to-violet-500 text-white rounded-lg sm:rounded-xl text-base sm:text-lg font-semibold hover:shadow-lg hover:shadow-purple-500/25 dark:hover:shadow-purple-400/25 transform hover:-translate-y-1 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none"
              >
                {isSubmitting ?
